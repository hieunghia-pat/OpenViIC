...
from models.rstnet.language_model import BertAdaptiveLanguageModel
...
if __name__ == '__main__':
    ...
    model = BertAdaptiveLanguageModel(padding_idx=text_field.vocab.stoi['<pad>'], pretrained_name=args.pretrained_name, bert_hidden_size=768, vocab_size=len(text_field.vocab)).to(device)
