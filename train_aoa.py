...
from models.aoa import Transformer, TransformerEncoder, TransformerDecoderLayer, ScaledDotProductAttention
import torch
...
if __name__ == '__main__':
    ...
    print('Attention on Attention Transformer Training')
