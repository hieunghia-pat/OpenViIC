...
class TransformerEncoder(nn.Module):
    def __init__(self, N, padding_idx, d_in=2048, d_model=512, d_k=64, d_v=64, h=8, d_ff=2048, dropout=.1,
                 alpha=0.1, beta=0.2, identity_map_reordering=False, attention_module=None, attention_module_kwargs=None):
    ...
    def forward(self, input, attention_weights=None):
        ...
        out1, out2, out3 = outs
        out2 = self.alpha*self.self_att(out2, out1, out1) + out2
        out3 = self.alpha*self.self_att(out3, out2, out2) + out3
